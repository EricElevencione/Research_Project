...
const RegionSidebar = ({ sidebarOpen, setSidebarOpen }: RegionSidebarProps) => {
  ...
  const navItems = [
    { path: "/region-dashboard", icon: HomeIcon, text: "Home" },
    { path: "/region-incentives", icon: IncentivesIcon, text: "Subsidy" },
    { path: "/region-inventory", icon: InventoryIcon, text: "Inventory" },
  ];
      ...
      <div className={`sidebar ${sidebarOpen ? "sidebar-open" : ""}`}>
        <nav className="sidebar-nav">
          ...
          <div className="sidebar-logo">
            ...
            <span className="sidebar-logo-title">Region Portal</span>
          </div>
