...
export const LandownerProfileDisplay: React.FC<LandownerProfileDisplayProps> = ({
  landowner,
}) => {
                ...
                <div key={parcel.id} className="farmer-modal-parcel-card">
                  ...
                  <div className="farmer-modal-parcel-details">
                    ...
                    <div className="farmer-modal-parcel-item">
                      ...
                      <span className="farmer-modal-value">
                        {typeof parcel.totalFarmAreaHa === "number"
                          ...
                          : parseFloat(String(parcel.totalFarmAreaHa)).toFixed(
                              4,
                            )}{" "}
                        ha
                      </span>
                    ...
                    <div className="farmer-modal-parcel-item">
                      ...
                      <span className="farmer-modal-value">
                        {parcel.ownershipDocumentNo || "N/A"}
                      </span>
                    </div>
                  </div>
                </div>
