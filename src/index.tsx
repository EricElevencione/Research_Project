  ...
  return (
    <HashRouter>
      <Routes>
        ...
        />
        <Route
          path="/view-allocation/:allocationId"
          element={
            <ProtectedRoute>
              <ViewAllocation />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/technician-farmerprofile/:id"
          element={
            <ProtectedRoute>
              <TechFarmerProfile />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/technician-pick-land-parcel/:ownerId"
          element={
            <ProtectedRoute>
              <TechPickLandParcel />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/technician-create-allocation"
          element={
            <ProtectedRoute>
        ...
        />
        <Route
          path="/technician-add-farmer-request/:allocationId"
          element={
            <ProtectedRoute>
        ...
        />
        <Route
          path="/technician-view-allocation/:allocationId"
          element={
            <ProtectedRoute>
              <TechViewAllocation />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/technician-manage-requests/:allocationId"
          element={
            <ProtectedRoute>
              <TechManageRequests />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/jo-add-farmer-request/:allocationId"
          element={
            <ProtectedRoute>
              <JoAddFarmerRequest />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/jo-manage-requests/:allocationId"
          element={
            <ProtectedRoute>
              <JoManageRequests />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/jo-view-allocation/:allocationId"
          element={
            <ProtectedRoute>
              <JoViewAllocation />
            </ProtectedRoute>
