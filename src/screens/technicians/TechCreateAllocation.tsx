...
const TechCreateAllocation: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        "🔗 Navigating to:",
        `/technician-add-farmer-request/${allocationId}`,
      );
      setTimeout(() => {
      ...
      <div className="tech-allocation-page">
        ...
        <div className="tech-allocation-main-content">
          ...
          <div className="tech-allocation-header">
            <h2 className="tech-allocation-title">
              Create Regional Allocation
            </h2>
          ...
          <div className="tech-allocation-content-card">
            <form onSubmit={handleSubmit}>
                ...
                <div className="tech-allocation-grid-2">
                  <div className="tech-allocation-field">
                    <label className="tech-allocation-label">
                      Allocation Date{" "}
                      <span className="tech-allocation-required">*</span>
                    </label>
                    <input
                      type="date"
                  ...
                  <div className="tech-allocation-field">
                    ...
                    <div className="tech-allocation-season-display">
                      {formData.season ? (
                        ...
                        <span className="tech-allocation-season-placeholder">
                          Select a date first
                        </span>
                      )}
                    </div>
              ...
              <div className="tech-allocation-section">
                ...
                <div className="tech-allocation-grid-2">
                  <div className="tech-allocation-field">
                    <label className="tech-allocation-label">Jackpot</label>
                    <input
                      type="number"
                      name="jackpot_kg"
                  ...
                  <div className="tech-allocation-field">
                    <label className="tech-allocation-label">US88</label>
                    <input
                      type="number"
                      name="us88_kg"
                  ...
                  <div className="tech-allocation-field">
                    <label className="tech-allocation-label">TH82</label>
                    <input
                      type="number"
                      name="th82_kg"
                  ...
                  <div className="tech-allocation-field">
                    <label className="tech-allocation-label">RH9000</label>
                    <input
                      type="number"
                      name="rh9000_kg"
                  ...
                  <div className="tech-allocation-field">
                    <label className="tech-allocation-label">Lumping143</label>
                    <input
                      type="number"
                      name="lumping143_kg"
                  ...
                  <div className="tech-allocation-field">
                    <label className="tech-allocation-label">LP296</label>
                    <input
                      type="number"
                      name="lp296_kg"
