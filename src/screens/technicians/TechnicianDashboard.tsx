...
>>>>>>> 3405086e1de361b58526f3720d311f5faef5da57
  ...
  const completedCount =
    dashboardData?.barangayChecklist?.filter((r) => r.isComplete).length || 0;
        ...
        <div className="tech-dashboard-main-content">
          ...
          <div className="tech-dashboard-stats-row">
            <div className="tech-stat-card">
              ...
              <div className="tech-stat-info">
                <span className="tech-stat-value">
                  {loading ? "..." : (dashboardData?.totalFarmers ?? 0)}
                </span>
                <span className="tech-stat-label">Total Farmers</span>
              </div>
            </div>
            ...
            <div className="tech-stat-card">
              ...
              <div className="tech-stat-info">
                <span className="tech-stat-value">
                  {loading ? "..." : (dashboardData?.totalPlotted ?? 0)}
                </span>
                <span className="tech-stat-label">Plotted Parcels</span>
              </div>
            </div>
            ...
            <div className="tech-stat-card">
              ...
              <div className="tech-stat-info">
                <span className="tech-stat-value">
                  {loading ? "..." : (dashboardData?.totalUnplotted ?? 0)}
                </span>
                <span className="tech-stat-label">Unplotted Parcels</span>
              </div>
            </div>
            ...
            <div className="tech-stat-card">
              ...
              <div className="tech-stat-info">
                <span className="tech-stat-value">
                  {loading ? "..." : `${completedCount}/${totalBarangays}`}
                </span>
                <span className="tech-stat-label">Barangays Complete</span>
              </div>
            </div>
              ...
              <div className="tech-checklist-table-wrapper">
                <table className="tech-checklist-table">
                  ...
                  <tbody>
                    {loading ? (
                      <tr>
                        <td colSpan={4} className="tech-checklist-loading">
                          Loading...
                        </td>
                      </tr>
                    ) : filteredChecklist.length === 0 ? (
                      <tr>
                        <td colSpan={4} className="tech-checklist-empty">
                          No barangays found
                        </td>
                      </tr>
                    ) : (
                      filteredChecklist.map((row) => {
                        const unplotted = row.parcelCount - row.plottedParcels;
                        return (
                          <tr
                            key={row.barangay}
                            className={row.isComplete ? "row-complete" : ""}
                          >
                            <td className="brgy-name">{row.barangay}</td>
                            <td className="brgy-count">{row.parcelCount}</td>
                            <td className="brgy-count">
                              <span
