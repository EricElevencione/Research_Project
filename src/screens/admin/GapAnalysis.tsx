...
const GapAnalysis: React.FC = () => {
  ...
  const renderGapRow = (
    ...
    if (!item) {
      return (
        <tr key={label}>
          <td className="item-label" data-label={itemColumnLabel}>
            {label}
          </td>
          <td className="number-cell" colSpan={5}>
            No data available
          </td>
        </tr>
      );
    ...
    return (
      <tr key={label}>
        ...
        <td className="number-cell" data-label="Allocated">
          {formatNumber(item.allocated)} {unit}
        </td>
        <td className="number-cell" data-label="Requested">
          {formatNumber(item.requested || item.estimated || 0)} {unit}
        </td>
        <td className={`number-cell gap-cell ${statusClass}`} data-label="Gap">
          {item.gap > 0 && "+"}
          {formatNumber(item.gap)} {unit}
        </td>
        <td className="number-cell" data-label="Fulfillment Rate">
    ...
    <div className="gap-analysis-container has-mobile-sidebar">
      ...
      <div className="main-content gap-main-content">
        ...
        <div className="content-header gap-content-header">
          ...
          <p>
            Compare regional allocation vs farmer requests to identify shortages
            and surpluses
          </p>
        </div>
        ...
        {loading && (
          <div className="loading-message">Loading gap analysis data...</div>
        )}
            ...
            <div className="summary-cards">
              <div className="summary-card">
                ...
                <p className="summary-value">
                  {new Date(gapData.allocation_date).toLocaleDateString(
                    "en-US",
                    {
                      year: "numeric",
                      month: "long",
              ...
              <div className="summary-card">
                <h3>Season</h3>
                <p className="summary-value">
                  {gapData.season.replace("_", " ").toUpperCase()}
                </p>
              </div>
            </div>
              ...
              showRecommendations && (
                ...
                >
                  ...
                  >
                    {recommendations.summary.critical_issues > 0 && (
                      ...
                      >
                        ...
                        >
                          {recommendations.summary.critical_issues}
                        </div>
                      </div>
                    )}
                    {recommendations.summary.high_priority_issues > 0 && (
                      ...
                      >
                        ...
                        >
                          {recommendations.summary.high_priority_issues}
                        </div>
                      </div>
                    )}
                    <div
                    ...
                    >
                      ...
                      >
                        {recommendations.summary.shortages}
                      </div>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {recommendations.summary.opportunities}
                      </div>
                    </div>
                  </div>
                        ...
                        >
                          ...
                          {rec.actions && rec.actions.length > 0 && (
                            <details style={{ marginTop: "12px" }}>
                              ...
                              >
                                View {rec.actions.length} Recommended Action
                                {rec.actions.length > 1 ? "s" : ""}
                              </summary>
                              <div
                                style={{
                                  marginTop: "8px",
                  ...
                  {recommendations.recommendations.length > 5 && (
                    ...
                    >
                      Showing top 5 of {recommendations.recommendations.length}{" "}
                      recommendations
                    </div>
                  )}
                </div>
              ...
              <div className="table-container">
                <table className="gap-table" data-responsive="stack">
                  ...
                  <tbody>
                    {renderGapRow(
                      "Urea 46-0-0",
                      (gapData as any).fertilizer_gap?.urea,
                      "bags",
                      "Fertilizer Type",
                    )}
                    {renderGapRow(
                      "Complete 14-14-14",
                      (gapData as any).fertilizer_gap?.complete_14_14_14,
                      "bags",
                      "Fertilizer Type",
                    )}
                    {renderGapRow(
                      "Ammonium Sulfate 21-0-0",
                      (gapData as any).fertilizer_gap?.ammonium_sulfate,
                      "bags",
                      "Fertilizer Type",
                    )}
                    {renderGapRow(
                      "Muriate of Potash 0-0-60",
                      (gapData as any).fertilizer_gap?.muriate_potash,
                      "bags",
                      "Fertilizer Type",
                    )}
                  </tbody>
              ...
              <div className="table-container">
                <table className="gap-table" data-responsive="stack">
                  ...
                  <tbody>
                    {renderGapRow(
                      "Rice Seeds",
                      (gapData as any).seeds_gap?.rice_seeds,
                      "kg",
                      "Seed Type",
                    )}
                    {renderGapRow(
                      "Corn Seeds",
                      (gapData as any).seeds_gap?.corn_seeds,
                      "kg",
                      "Seed Type",
                    )}
                  </tbody>
            ...
            <div className="legend-card">
              ...
              <div className="legend-items">
                ...
                <div className="legend-item">
                  ...
                  <span>
                    Allocation exceeds requests (extra supply available)
                  </span>
                </div>
              </div>
            </div>
