...
const MODULE_PAGE_FALLBACKS: Record<string, AuditPageContext> = {
  ...
  INCENTIVES: { label: "Subsidy", path: "/jo-incentives" },
...
const AuditTrail: React.FC = () => {
  ...
  const formatRouteLabel = (path: string): string => {
    ...
    const routeAliases: { prefix: string; label: string }[] = [
      ...
      { prefix: "/incentives", label: "Subsidy" },
      { prefix: "/rsbsa", label: "RSBSA" },
      { prefix: "/jo-rsbsa", label: "JO RSBSA Registration" },
      { prefix: "/jo-rsbsa-landowner", label: "JO Landowner Registration" },
      { prefix: "/jo-rsbsapage", label: "JO RSBSA List" },
      { prefix: "/jo-farmer-registry", label: "JO Farmer Registry" },
      { prefix: "/jo-landowner-registry", label: "JO Landowner Registry" },
      { prefix: "/jo-land-registry", label: "JO Land Registry" },
      { prefix: "/jo-land-history-report", label: "JO Land History Report" },
      { prefix: "/jo-audit-trail", label: "JO Audit Trail" },
