...
BEGIN
    ...
    INSERT INTO rsbsa_submission (
        ...
        is_actively_farming, -- 👈 NEW COLUMN ADDED HERE
        status
    ) VALUES (
        ...
        COALESCE((p_data->>'isActivelyFarming')::BOOLEAN, FALSE), -- 👈 VALUE EXTRACTED FROM PAYLOAD HERE
        'Submitted'
    )
    ...
    LOOP
        ...
        IF v_has_existing_parcel_ref THEN
            ...
            IF v_history_record.id IS NOT NULL THEN
                ...
                IF v_parcel_is_registered_owner THEN
                    UPDATE land_history
        ...
        IF v_parcel_is_registered_owner AND v_prev_farmer_id IS NOT NULL THEN
            UPDATE rsbsa_farm_parcels
